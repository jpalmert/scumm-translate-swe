...
//     This file is generated by scripts/build_patcher.sh (Step 2) and is gitignored.
//
// To update a glyph: edit the BMP in internal/charset/bitmaps/, then re-run
// scripts/build_patcher.sh (which regenerates the .bin files as part of Step 2).
...
// Generated by scripts/build_patcher.sh Step 2 into gen/ (gitignored).
